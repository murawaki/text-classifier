...
SOURCEINFO := $(DATA_DIR)/source_info_en.tsv
...
DAILY_INPUTS = $(wildcard $(INPUT_DIR)/new-translated-files-en-202*.txt)
BASE_NAMES = $(subst new-translated-files-en-,,$(basename $(notdir $(DAILY_INPUTS))))

GPUID := -1

# $(1): BASE_NAME
define each_task
$(OUTPUT_DIR)/$(1).target.txt : $(INPUT_DIR)/new-translated-files-en-$(1).txt
